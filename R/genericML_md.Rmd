...
```
Is the propensity score error coming from the block randomization? Page 2763 footnote 6 mentions that is how assignment was done. 
...
2. CLAN breakdown of het treat effects
3. Including more covariates (from entire data)
4. GenML on other outcome/treatment variables